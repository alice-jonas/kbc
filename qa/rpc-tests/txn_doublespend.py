...
from test_framework import KbcTestFramework
...
class TxnMallTest(KbcTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 KBC:
        ...
        # First: use raw transaction API to send 1210 KBC to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50KBC for another
        ...
        # Node0's total balance should be starting balance, plus 100KBC for 
