...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/kbc"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Kbc Core"),
     ...
     * override -datadir in the kbc.conf file in the default data directory
     * (to be consistent with kbcd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
