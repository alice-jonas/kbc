...
#include "config/kbc-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatKbcURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + KbcUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatKbcURI(info));
}
