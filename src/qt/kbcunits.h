...
#ifndef KBC_QT_KBCUNITS_H
#define KBC_QT_KBCUNITS_H
...
/** Kbc unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KbcUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KbcUnits(QObject *parent);

    /** Kbc units.
      @note Source: https://en.kbc.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KBC,
...
typedef KbcUnits::Unit KbcUnit;

#endif // KBC_QT_KBCUNITS_H
