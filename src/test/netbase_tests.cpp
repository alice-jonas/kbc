...
{
    BOOST_CHECK(TestSplitHost("www.kbc.org", "www.kbc.org", -1));
    BOOST_CHECK(TestSplitHost("[www.kbc.org]", "www.kbc.org", -1));
    BOOST_CHECK(TestSplitHost("www.kbc.org:80", "www.kbc.org", 80));
    BOOST_CHECK(TestSplitHost("[www.kbc.org]:80", "www.kbc.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8633", "127.0.0.1", 8633));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8633", "127.0.0.1", 8633));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8633", "::ffff:127.0.0.1", 8633));
    BOOST_CHECK(TestSplitHost("[::]:8633", "::", 8633));
    BOOST_CHECK(TestSplitHost("::8633", "::8633", -1));
    BOOST_CHECK(TestSplitHost(":8633", "", 8633));
    BOOST_CHECK(TestSplitHost("[]:8633", "", 8633));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8633", "127.0.0.1:8633"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8633", "[::]:8633"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
