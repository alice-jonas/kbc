Kbc version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bitcoin/files/Kbc/bitcoin-0.7.0/

We recommend that everybody running prior versions of bitcoind/Kbc-Qt
...
Kbc Improvement Proposals implemented
