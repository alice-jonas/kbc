Kbc Core version 0.9.4 is now available from:
...
this update is incompatible with the Kbc system and could lead to consensus
forks.

Kbc Core released binaries from https://bitcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin/+archive/ubuntu/bitcoin
- A third-party or self-compiled Kbc Core

upgrade to Kbc Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
