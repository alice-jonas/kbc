Kbc-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Kbc/bitcoin-0.8.4/
...
code, causing the Kbc-Qt or bitcoind process to crash.
...
their own version of Kbc against Boost versions 1.50-1.52.
