Kbc-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitcoin/files/Kbc/bitcoin-0.8.6/
...
- Fix Kbc-Qt startup crash when clicking dock icon on OSX 
