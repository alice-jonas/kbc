Kbc version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Kbc/bitcoin-0.5.4/
...
Fix Kbc-Qt notifications under Growl 1.3.
Increase required age of Kbc-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKbc properly when installing Kbc-Qt over it. (Windows)
