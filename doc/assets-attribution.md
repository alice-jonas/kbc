The following is a list of assets used in the kbc source and their proper attribution.
...
* License: MIT
* Site: [https://kbctalk.org/index.php?topic=15276.0](https://kbctalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original kbc logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/kbc.icns, src/qt/res/src/kbc.svg,
	src/qt/res/src/kbc.ico, src/qt/res/src/kbc.png,
	src/qt/res/src/kbc_testnet.png, docs/kbc_logo_doxygen.png,
