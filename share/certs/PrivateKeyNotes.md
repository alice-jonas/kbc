...
unlocked to sign the Kbc-Qt.app bundle.
...
allowing somebody to distribute a Kbc-Qt.app or kbc-qt-setup.exe with a valid
...
that the kbc-qt.exe file inside the installer had not been tampered with.
