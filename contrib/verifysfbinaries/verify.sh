...
###   This script attempts to download the signature file SHA256SUMS.asc from kbc.org
...
SIGNATUREFILE="https://kbc.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://kbc.org/bin/"
VERSIONPREFIX="kbc-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'kbc-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[kbc-]<version>-[rc[0-9]] (example: kbc-0.9.2-rc1)"
   echo "wget output:"
